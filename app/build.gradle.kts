...
val apexVersionName: String = providers.gradleProperty("apexVersionName").getOrElse("0.24.0")
val apexVersionCode: Int = providers.gradleProperty("apexVersionCode").map(String::toInt).getOrElse(2400)
