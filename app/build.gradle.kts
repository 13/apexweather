...
val apexVersionName: String = providers.gradleProperty("apexVersionName").getOrElse("0.8.3")
val apexVersionCode: Int = providers.gradleProperty("apexVersionCode").map(String::toInt).getOrElse(803)
